...
print(f'Время выполнения (в секундах) и нагрузка (в процентах) каждой задачи с использованием потоков:')
...
print(f'Время выполнения (в секундах) и нагрузка (в процентах) каждой задачи с использованием процессов:')
...
print(f'Время выполнения (в секундах) и нагрузка (в процентах) каждой задачи с использованием асинхронности:')
